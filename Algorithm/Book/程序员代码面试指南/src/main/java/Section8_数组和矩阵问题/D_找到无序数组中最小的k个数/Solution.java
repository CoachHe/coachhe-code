package Section8_数组和矩阵问题.D_找到无序数组中最小的k个数;
...
public class Solution {
    ...
    public int getMedian(int[] arr, int begin, int end) {
        insertionSor(arr, begin, end);
        int sum = end + begin;
        int mid = (sum / 2) + ((sum % 2));
        return arr[mid];
    }

    public void insertionSor(int[] arr, int begin, int end) {
    ...
    public static void main(String[] args) {
        int[] arr = new int[]{1,3,54,234,123,4,34,12,12,1,223,345,456,656,56,};
        int k = 5;
        Solution s = new Solution();
        int[] b = s.getMinKNumsByBFPRT(arr, k);
        for (int tmp : b) {
